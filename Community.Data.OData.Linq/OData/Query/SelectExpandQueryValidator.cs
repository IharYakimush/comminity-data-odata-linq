...
namespace Community.OData.Linq.OData.Query
{
    ...
    /// <summary>
    /// Represents a validator used to validate a <see cref="ODataValidationSettings" /> based on the <see cref="SelectExpandQueryOption"/>.
    /// </summary>
    public class SelectExpandQueryValidator
    {
        ...
        public virtual void Validate(SelectExpandQueryOption selectExpandQueryOption, ODataValidationSettings validationSettings)
        {
            ...
            this._orderByQueryValidator = new OrderByModelLimitationsValidator(
                selectExpandQueryOption.Context.Model,
                this._defaultQuerySettings.EnableOrderBy);
            ...
            bool? countOption)
        {
            if (countOption == true)
            {
                if (EdmLibHelpers.IsNotCountable(
                    ...
                    structuredType,
                    edmModel,
                    this._defaultQuerySettings.EnableCount))
                {
                ...
                else
                {
                    ...
                    if (propertySegment != null)
                    {
                        if (EdmLibHelpers.IsNotSelectable(propertySegment.Property, pathProperty, pathStructuredType, edmModel,
                            this._defaultQuerySettings.EnableSelect))
                        {
            ...
            IEdmModel edmModel, IEdmNavigationProperty property)
        {
            ...
            {
                if (!this._defaultQuerySettings.EnableExpand ||
        ...
        private void ValidateRestrictions(
            ...
            ODataValidationSettings validationSettings)
        {
            IEdmModel edmModel = this._selectExpandQueryOption.Context.Model;
            ...
            {
                pathProperty = this._selectExpandQueryOption.Context.TargetProperty;
                pathStructuredType = this._selectExpandQueryOption.Context.TargetStructuredType;
            }
            else
            {
            ...
            foreach (SelectItem selectItem in selectExpandClause.SelectedItems)
            {
                ...
                if (expandItem != null)
                {
                    ...
                    if (edmModel != null)
                    {
                        this.ValidateOtherQueryOptionInExpand(property, edmModel, expandItem, validationSettings);
                        bool isExpandable;
                        ExpandConfiguration expandConfiguration;
                    ...
                    if (remainDepth.HasValue)
                    {
                        ...
                        {
                            this.ValidateLevelsOption(expandItem.LevelsOption, remainDepth.Value, currentDepth + 1, edmModel,
                                property);
                        }
                    }

                    this.ValidateRestrictions(remainDepth, currentDepth + 1, expandItem.SelectAndExpand, property,
                        validationSettings);
                    remainDepth = depth;
                }

                this.ValidateSelectItem(selectItem, pathProperty, pathStructuredType, edmModel);
            }
        }
    }
}
