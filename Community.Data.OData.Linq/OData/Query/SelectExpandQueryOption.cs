...
namespace Community.OData.Linq.OData.Query
{
    ...
    public class SelectExpandQueryOption
    {
        ...
        /// <param name="context">The <see cref="IEdmModel"/> which contains the <see cref="IEdmModel"/> and some type information.</param>
        /// <param name="queryOptionParser">The <see cref="ODataQueryContext"/> which is used to parse the query option.</param>
        ...
        private SelectExpandQueryOption(string select, string expand, ODataQueryContext context)
        {
            ...
            this.RawExpand = expand;
            this.Validator = SelectExpandQueryValidator.GetSelectExpandQueryValidator(context);
            this._queryOptionParser = new ODataQueryOptionParser(
                context.Model,
                context.ElementType,
        ...
        public IQueryable ApplyTo(IQueryable queryable, ODataQuerySettings settings)
        {
            ...
            ODataQuerySettings updatedSettings = this.Context.UpdateQuerySettings(settings, queryable);
        ...
        public object ApplyTo(object entity, ODataQuerySettings settings)
        {
            ...
            ODataQuerySettings updatedSettings = this.Context.UpdateQuerySettings(settings, query: null);
