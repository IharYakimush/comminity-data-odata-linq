...
namespace Community.OData.Linq.Builder
{
    ...
    public abstract class OperationConfiguration
    {
        ...
        {
            get { return this._namespace ?? this.ModelBuilder.Namespace; } 
        ...
        {
            get { return this._bindingParameter; }
        }
        ...
        internal void ReturnsFromEntitySetImplementation<TEntityType>(string entitySetName) where TEntityType : class
        {
            ...
            this.NavigationSource = this.ModelBuilder.EntitySets.Single(s => s.Name == entitySetName);
            this.ReturnType = this.ModelBuilder.GetTypeConfigurationOrNull(typeof(TEntityType));
            this.OptionalReturn = true;
        }
        ...
        internal void ReturnsCollectionFromEntitySetImplementation<TElementEntityType>(string entitySetName) where TElementEntityType : class
        {
            ...
            this.NavigationSource = this.ModelBuilder.EntitySets.Single(s => s.Name == entitySetName);
            IEdmTypeConfiguration elementType = this.ModelBuilder.GetTypeConfigurationOrNull(typeof(TElementEntityType));
            this.ReturnType = new CollectionTypeConfiguration(elementType, clrCollectionType);
            this.OptionalReturn = true;
        }
        ...
        {
            IEdmTypeConfiguration configuration = this.GetOperationTypeConfiguration(clrReturnType);
            this.ReturnType = configuration;
            this.OptionalReturn = EdmLibHelpers.IsNullable(clrReturnType);
        }
        ...
        internal void ReturnsCollectionImplementation<TReturnElementType>()
        {
            ...
            IEdmTypeConfiguration edmElementType = this.GetOperationTypeConfiguration(clrElementType);
            this.ReturnType = new CollectionTypeConfiguration(edmElementType, clrCollectionType);
            this.OptionalReturn = EdmLibHelpers.IsNullable(clrElementType);
        }
        ...
        public ParameterConfiguration Parameter(Type clrParameterType, string name)
        {
            ...
            IEdmTypeConfiguration parameterType = this.GetOperationTypeConfiguration(clrParameterType);
        ...
        public ParameterConfiguration CollectionParameter<TElementType>(string name)
        {
            ...
            IEdmTypeConfiguration elementTypeConfiguration = this.GetOperationTypeConfiguration(typeof(TElementType));
        ...
        public ParameterConfiguration EntityParameter<TEntityType>(string name) where TEntityType : class
        {
            ...
            IEdmTypeConfiguration parameterType =
                this.ModelBuilder.StructuralTypes.FirstOrDefault(t => t.ClrType == entityType) ??
                this.ModelBuilder.AddEntityType(entityType);
        ...
        public ParameterConfiguration CollectionEntityParameter<TElementEntityType>(string name) where TElementEntityType : class
        {
            ...
            IEdmTypeConfiguration elementTypeConfiguration =
                this.ModelBuilder.StructuralTypes.FirstOrDefault(t => t.ClrType == elementType) ??
                this.ModelBuilder.AddEntityType(elementType);
        ...
        private IEdmTypeConfiguration GetOperationTypeConfiguration(Type clrType)
        {
            ...
            if (type.IsEnum)
            {
                edmTypeConfiguration = this.ModelBuilder.GetTypeConfigurationOrNull(type);
            ...
            if (edmTypeConfiguration == null)
            {
                if (type.IsEnum)
                {
                    EnumTypeConfiguration enumTypeConfiguration = this.ModelBuilder.AddEnumType(type);
