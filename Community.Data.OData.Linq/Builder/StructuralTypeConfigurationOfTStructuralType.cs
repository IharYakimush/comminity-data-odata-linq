...
namespace Community.OData.Linq.Builder
{
    ...
    public abstract class StructuralTypeConfiguration<TStructuralType> where TStructuralType : class
    {
        ...
        {
            get { return this._configuration.Properties; }
        }
        ...
        {
            return this.GetPrimitivePropertyConfiguration(propertyExpression, optional: true) as LengthPropertyConfiguration;
        }
        ...
        {
            return this.GetPrimitivePropertyConfiguration(propertyExpression, optional: true);
        }
        ...
        {
            return this.GetPrimitivePropertyConfiguration(propertyExpression, optional: true) as DecimalPropertyConfiguration;
        }
        ...
        public DecimalPropertyConfiguration Property(Expression<Func<TStructuralType, decimal>> propertyExpression)
        {
            return this.GetPrimitivePropertyConfiguration(propertyExpression, optional: false) as DecimalPropertyConfiguration;
        }
        ...
        {
            return this.GetPrimitivePropertyConfiguration(propertyExpression, optional: true) as PrecisionPropertyConfiguration;
        }
        ...
        public PrecisionPropertyConfiguration Property(Expression<Func<TStructuralType, TimeOfDay>> propertyExpression)
        {
            return this.GetPrimitivePropertyConfiguration(propertyExpression, optional: false) as PrecisionPropertyConfiguration;
        }
        ...
        public PrimitivePropertyConfiguration Property<T>(Expression<Func<TStructuralType, T>> propertyExpression) where T : struct
        {
            return this.GetPrimitivePropertyConfiguration(propertyExpression, optional: false);
        }
        ...
        {
            return this.GetEnumPropertyConfiguration(propertyExpression, optional: true);
        }
        ...
        public EnumPropertyConfiguration EnumProperty<T>(Expression<Func<TStructuralType, T>> propertyExpression) where T : struct
        {
            return this.GetEnumPropertyConfiguration(propertyExpression, optional: false);
        }
        ...
        {
            return this.GetComplexPropertyConfiguration(propertyExpression);
        }
        ...
        {
            return this.GetCollectionPropertyConfiguration(propertyExpression);
        }
            ...
            Expression<Func<TStructuralType, TTargetEntity, bool>> referentialConstraintExpression) where TTargetEntity : class
        {
            NavigationPropertyConfiguration navigation =
                this.GetOrCreateNavigationProperty(navigationPropertyExpression, EdmMultiplicity.ZeroOrOne);
        ...
        {
            this._configuration.QueryConfiguration.SetExpand(properties, maxDepth, SelectExpandType.Allowed);
            this._configuration.AddedExplicitly = true;
            return this;
        }
        ...
        {
            this._configuration.QueryConfiguration.SetExpand(null, maxDepth, expandType);
            this._configuration.AddedExplicitly = true;
            return this;
        }
        ...
        {
            this._configuration.QueryConfiguration.SetExpand(null, maxDepth, SelectExpandType.Allowed);
            this._configuration.AddedExplicitly = true;
            return this;
        }
        ...
        internal NavigationPropertyConfiguration GetOrCreateNavigationProperty(Expression navigationPropertyExpression, EdmMultiplicity multiplicity)
        {
            ...
            return this._configuration.AddNavigationProperty(navigationProperty, multiplicity);
        }
        ...
        private EnumPropertyConfiguration GetEnumPropertyConfiguration(Expression propertyExpression, bool optional)
        {
            ...
            EnumPropertyConfiguration property = this._configuration.AddEnumProperty(propertyInfo);
            if (optional)
            {
                property.IsOptional();
            }
        ...
        private CollectionPropertyConfiguration GetCollectionPropertyConfiguration(Expression propertyExpression, bool optional = false)
        {
            ...
            property = this._configuration.AddCollectionProperty(propertyInfo);
