...
namespace Community.Data.OData.Linq.Builder
{
    ...
    public class BindingPathConfiguration<TStructuralType> where TStructuralType : class
    {
        ...
        {
            get { return this._bindingPath.ConvertBindingPath(); }
        }
        ...
        {
            return this.HasManyPath<TTargetType>(pathExpression, contained: false);
        }
        ...
        {
            return this.HasManyPath(pathExpression, contained: false);
        }
        ...
        public BindingPathConfiguration<TTargetType> HasSinglePath<TTargetType>(
            ...
            where TTargetType : class
        {
            return this.HasSinglePath<TTargetType>(pathExpression, required: false, contained: false);
        }
        ...
        public BindingPathConfiguration<TTargetType> HasSinglePath<TTargetType, TDerivedType>(
            ...
            where TDerivedType : class, TStructuralType
        {
            return this.HasSinglePath(pathExpression, required: false, contained: false);
        }
            ...
            where TTargetType : class
        {
            ...
            NavigationPropertyConfiguration navigation = this._structuralType.HasMany(navigationExpression);
