    ...
    public abstract class NavigationSourceConfiguration<TEntityType> where TEntityType : class
    {
            ...
            where TDerivedEntityType : class, TEntityType
        {
            ...
            EntityTypeConfiguration<TDerivedEntityType> derivedEntityType =
                this._modelBuilder.EntityType<TDerivedEntityType>().DerivesFrom<TEntityType>();
            ...
            return this.Configuration.AddBinding(navigation,
                this._modelBuilder.EntitySet<TTargetType>(entitySetName)._configuration, bindingPath);
        }
            ...
            where TTargetType : class
        {
            ...
            return this.Configuration.AddBinding(this.EntityType.HasMany(navigationExpression),
                this._modelBuilder.EntitySet<TTargetType>(entitySetName)._configuration);
        }
            ...
            NavigationSourceConfiguration<TTargetType> targetEntitySet) where TTargetType : class
        {
            ...
            return this.Configuration.AddBinding(this.EntityType.HasMany(navigationExpression), targetEntitySet.Configuration);
        }
            ...
            where TTargetType : class
        {
            ...
            return this.Configuration.AddBinding(this.EntityType.HasRequired(navigationExpression),
                this._modelBuilder.EntitySet<TTargetType>(entitySetName).Configuration);
        }
            ...
            where TDerivedEntityType : class, TEntityType
        {
            ...
            return this.Configuration.AddBinding(navigation,
                this._modelBuilder.EntitySet<TTargetType>(entitySetName).Configuration, bindingPath);
        }
            ...
            NavigationSourceConfiguration<TTargetType> targetEntitySet) where TTargetType : class
        {
            ...
            return this.Configuration.AddBinding(this.EntityType.HasRequired(navigationExpression), targetEntitySet.Configuration);
        }
            ...
            where TTargetType : class
        {
            ...
            return this.Configuration.AddBinding(this.EntityType.HasOptional(navigationExpression),
                this._modelBuilder.EntitySet<TTargetType>(entitySetName).Configuration);
        }
            ...
            NavigationSourceConfiguration<TTargetType> targetEntitySet) where TTargetType : class
        {
            ...
            return this.Configuration.AddBinding(this.EntityType.HasOptional(navigationExpression), targetEntitySet.Configuration);
        }
            ...
            where TTargetType : class
        {
            ...
            return this.Configuration.AddBinding(this.EntityType.HasRequired(navigationExpression),
                this._modelBuilder.Singleton<TTargetType>(singletonName).Configuration);
        }
            ...
            where TDerivedEntityType : class, TEntityType
        {
            ...
            return this.Configuration.AddBinding(navigation,
                this._modelBuilder.Singleton<TTargetType>(singletonName).Configuration, bindingPath);
        }
            ...
            NavigationSourceConfiguration<TTargetType> targetSingleton) where TTargetType : class
        {
            ...
            return this.Configuration.AddBinding(this.EntityType.HasRequired(navigationExpression), targetSingleton.Configuration);
        }
